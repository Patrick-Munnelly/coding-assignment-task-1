...
const Movie = ({ movie, viewTrailer, lastMovieRef, index }) => {
  const nonLastMovieRef = useRef(null);
  ...
  return (
    <div
      ...
      id={`movie-card-${index}`}
      ref={lastMovieRef ? lastMovieRef : nonLastMovieRef}
      className=""
    >
      <div
      ...
      >
        ...
        <button
          data-testid="close-card-details-button"
          type="button"
          className="close"
